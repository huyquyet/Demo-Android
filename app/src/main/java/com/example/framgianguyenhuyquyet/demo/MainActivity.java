...
//        });
        ...
        btnshowallcontact.setOnClickListener(myEvent);
        btnaccesscalllog = (Button) findViewById(R.id.btnaccesscalllog);
        btnaccesscalllog.setOnClickListener(myEvent);
        btnaccessmediastore = (Button) findViewById(R.id.btnmediastore);
        btnaccessmediastore.setOnClickListener(myEvent);
        btnaccessbookmarks = (Button) findViewById(R.id.btnaccessbookmarks);
        btnaccessbookmarks.setOnClickListener(myEvent);
    ...
    View.OnClickListener myEvent = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (v == btnshowallcontact) {
                intent = new Intent(MainActivity.this, ShowAllContactActivity.class);
